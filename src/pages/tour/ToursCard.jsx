...
const ToursCard = ({tours}) => {
  return (
    <main className=" grid grid-cols-2 gap-20">
      {tours.map((tour,index)=><div className=" rounded-e-md relative flex gap-10 w-full border shadow-lg bg-sky-300 bg-opacity-10 p-5 min-h-[300px] h-full" key={index}>
        {/* image section  */}
