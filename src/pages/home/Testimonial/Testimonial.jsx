...
const Testimonial = () => {
  ...
  return (
    <section className=" w-[90%] my-10 md:w-[90%] lg:w-[85%] mx-auto">
      ...
      <section className="mx-auto px-2 lg:px-5">
      
         <Slider {...settings}>
         {testimonials?.map((testimonial, index) => (
            <div className={` px-3`} key={index}>
              <div className="container bg-base-200 bg-opacity-10 shadow-md border flex flex-col w-full  max-w-lg p-2 lg:p-6  mx-auto divide-y rounded-md divide-gray-300 lg:max-h-[260px]  lg:min-h-[260px] ">
